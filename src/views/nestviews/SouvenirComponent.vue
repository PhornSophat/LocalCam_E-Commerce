<template>
  <div class="grid grid-cols-2 gap-8 md:grid-cols-4">
    <div
      v-for="product in beautyHomeProducts"
      :key="product.id"
    ...
    >
      ...
      >
        ...
        <div class="absolute top-4 left-4">
          <span
            class="px-3 py-1 text-xs font-semibold text-white bg-green-500 rounded-full shadow-lg"
          >
            {{ product.tag }}
          </span>
        </div>
...
const beautyHomeProducts = ref([ { id: 1, name: 'Bamboo Basket', price: 25, image:
'https://img.kwcdn.com/product/fancy/58719d04-5293-49e8-b083-316513685ea0.jpg', tag: 'Handmade' }, {
id: 2, name: 'Woven Tray Set', price: 35, image:
'https://img.lazcdn.com/g/ff/kf/S2525de3bd5c248bab80aabed79eafb56E.jpg_720x720q80.jpg', tag:
'Premium' }, { id: 3, name: 'Wood Storage Box', price: 45, image:
'https://m.media-amazon.com/images/I/61t7P2bFiTL._AC_UF894,1000_QL80_.jpg', tag: 'Popular' }, { id:
4, name: 'Traditional Mat', price: 28, image: 'https://s3.ams.com.kh/economy/2024/02/Hand3.jpg',
tag: 'Eco' }, { id: 5, name: 'Bamboo Mirror Frame', price: 55, image:
'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcMZfqsaaQXgMCDjhAe7jbZFLKYBAyXmHeQg&s', tag:
'New' }, { id: 6, name: 'Wood Candle Holder', price: 18, image:
'https://business-cambodia.com/cms/assets/8f925357-dd64-4974-9fd4-9d0745082b56', tag: 'Handmade' },
{ id: 7, name: 'Natural Fiber Basket', price: 32, image:
'https://img.kwcdn.com/product/fancy/58719d04-5293-49e8-b083-316513685ea0.jpg', tag: 'Eco' }, { id:
8, name: 'Decorative Wall Art', price: 68, image:
'https://static.loghome.com/media/LHD_0308_MAG16_11868_2023-05-15_14-11.jpg', tag: 'Premium' }, ]);
<!-- </script> -->
