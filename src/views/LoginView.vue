...
import { ensureAdminProfile, isUserAdmin } from '../lib/adminSetup'
...
<template>
  <div class="min-h-screen flex flex-col bg-[#F1EEE5] font-Poppins">
    ...
    <main class="flex items-center justify-center flex-1 px-5 py-10">
      <div
        class="grid w-full max-w-5xl overflow-hidden bg-white border border-gray-100 shadow-2xl md:grid-cols-2 rounded-2xl"
      >
        <div
          class="relative flex-col items-center justify-center hidden p-16 overflow-hidden text-white md:flex bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700"
        >
          <div class="absolute inset-0 opacity-20">
            <div
              class="absolute top-1/4 left-1/4 w-64 h-64 bg-amber-200 rounded-full blur-[80px]"
            ></div>
            <div
              class="absolute bottom-1/4 right-1/4 w-64 h-64 bg-slate-400 rounded-full blur-[80px]"
            ></div>
          </div>
          ...
          <div class="relative z-10 flex flex-col items-center text-center">
            ...
            <p class="max-w-xs text-sm leading-relaxed opacity-80">
              Access your artisan collection, manage your orders, and explore the best of Cambodian
              craftsmanship.
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-col justify-center p-10 md:p-16">
            ...
            <p class="text-sm text-gray-500">
              {{
                $route.query.redirect
                  ? 'Please login to finish your order.'
          ...
          <div
            v-if="errorMessage"
            class="flex items-center gap-3 p-4 mb-6 text-xs font-bold text-red-700 border-l-4 border-red-500 rounded bg-red-50"
          >
          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            <div>
              <label
                for="email"
                class="block mb-1.5 text-xs font-black uppercase tracking-wider text-gray-400"
                >Email Address</label
              >
              <input
                type="email"
            ...
            <div class="flex items-center justify-between py-2">
              <label class="flex items-center gap-2 cursor-pointer group">
                ...
                />
                <span
                  class="text-xs font-bold text-gray-500 transition-colors group-hover:text-gray-800"
                  >Stay logged in</span
                >
              </label>
              <router-link
                to="/forgot-password"
                class="text-xs font-black text-gray-800 hover:underline"
          ...
          <div class="relative my-8 text-center">
            ...
            <span
              class="relative px-4 bg-white text-[10px] font-black uppercase tracking-widest text-gray-400"
              >Social Login</span
            >
          </div>
          ...
          <div class="grid grid-cols-2 gap-4 mb-8">
            <button
              ...
              class="flex items-center justify-center gap-2 py-3 transition-all border border-gray-200 rounded-xl hover:bg-gray-50"
            >
              <img
          ...
          <div class="text-xs font-medium text-center text-gray-500">
            ...
            <router-link to="/signup" class="ml-1 font-black text-gray-900 hover:underline"
    ...
    <footer class="bg-[#2D2A26] text-white/40 py-6">
      <div
        class="flex flex-col items-center justify-between gap-4 px-5 mx-auto max-w-7xl md:flex-row"
      >
        <div class="text-[10px] font-bold uppercase tracking-widest text-white/20">
          © 2026 LocalCam Studio
        </div>
        <div class="flex gap-6">
          <a
            href="#"
            class="text-[10px] hover:text-white transition-colors uppercase font-bold tracking-widest"
            >Support</a
          >
          <a
            href="#"
